...
int nAnonymizeBrazilAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Brazil
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Brazil
    // Mac: ~/Library/Application Support/Brazil
    // Unix: ~/.Brazil
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Brazil";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "brazil.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "brazild.pid"));
